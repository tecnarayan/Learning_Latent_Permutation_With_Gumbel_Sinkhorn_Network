...
def reconstruct_image_from_pieces(pieces, perm_index, num_pieces, height, width, channels=1):
    """
    ...
    :param channels: Number of channels in the image (1 for grayscale, 3 for RGB, etc.)
    ...
    reconstructed_image = torch.zeros(channels, height, width)  # (channels, height, width)
    # print("initialization ", reconstructed_image.shape)
